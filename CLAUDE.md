...
- Host: Cloudflare Workers (GitHub push → otomatik deploy; repo root = publish dir)
...
## Deploy
Her değişiklik sonrası commit + push → Cloudflare Workers otomatik deploy eder. Kullanıcı onayı bekleme.
